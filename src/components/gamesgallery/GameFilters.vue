<template>
  <transition name="fade-slide" mode="out-in">
    ...
    <div v-else class="filter-bar">
      ...
      <input
        v-model="localFilters.developer"
...
import { reactive, watch, type VNodeRef } from "vue"
...
interface Props {
  ...
  expandedInputRef: VNodeRef
}

const props = defineProps<Props>()

const emit = defineEmits<{
  (e: "toggle-dropdown" | "close-dropdown", type: "genres" | "tags"): void
...
const emitToggleDropdown = (type: "genres" | "tags") => {
  emit("toggle-dropdown", type)
}
const emitCloseDropdown = (type: "genres" | "tags") => {
