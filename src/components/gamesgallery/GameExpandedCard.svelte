	...
	<div class="book-expanded" class:show={game !== null} class:explicit-content={game.explicit}>
		<div class="expanded-header">
			...
			<div class="expanded-cover">
				<img
					src={game.coverImage}
					alt={$_('cover-of-props-book-title', { values: { title: game.title } })}
			...
			<div class="expanded-basic-info">
				...
				<div class="expanded-rating">
					<span class="stars">
						{#each Array(game.title === 'One Piece' ? 50 : 5) as _, star}
				...
				<div class="links-section">
					...
					<div class="links-grid">
						{#each game.links as link (link.title)}
							<a href={link.url} target="_blank" rel="noopener noreferrer" class="book-link">
