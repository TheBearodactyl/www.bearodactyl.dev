...
{:else}
  <div class="filter-bar" in:slide={{ duration: 300 }} out:slide={{ duration: 300 }}>
    ...
    <select bind:value={searchFilters.status} onchange={(e) => updateStatus(e.currentTarget.value)}>
    ...
    <select 
      ...
      onchange={(e) => updateRating(e.currentTarget.value ? Number(e.currentTarget.value) : null)}
    >
