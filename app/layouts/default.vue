            ...
            <div class="menu-items" :class="{ 'open': isMenuOpen }">
                <div class="theme-switcher">
                    <select id="theme-select" v-model="selectedTheme" @change="changeTheme">
                        ...
                        <option value="carbonized">Carbonized</option>
                        <option value="gotham">Gotham</option>
                        <option value="iceberg">Iceberg</option>
                        <option value="papercolor">Papercolor</option>
                        <option value="jellybeans">Jellybeans</option>
                        <option value="materialbox">Materialbox</option>
                ...
                <button v-if="route.path !== '/'" class="home_button" @click="goHome" aria-label="Home"
                    title="Go to Home">
...
.lang-switcher-aligned select:focus {
    border-color: var(--rp-foam);
    box-shadow: 0 0 0 3px var(--rp-foam), 0 4px 12px rgba(0, 0, 0, 0.4);
}
